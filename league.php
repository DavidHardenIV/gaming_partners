...
<head>
    <meta charset="UTF-8">
    <title>Find League of Legends Teammates</title>
...
<main>
    <section class="game-form">
        <div class="container">
            <h1 class="game-title">Find Teammates for League of Legends</h1>
            <form action="submit_waiting.php" method="POST">
                <input type="hidden" name="game" value="League of Legends">

                <label for="riot_name">Enter Your Summoner Name:</label>
                <input type="text" name="riot_name" placeholder="Enter your Summoner Name" required>
                ...
                <textarea name="additional_notes" placeholder="Lane, champ pool, time zone, etc."></textarea>
    ...
    <section class="waiting-lobby">
        <div class="container">
            ...
            <table class="waiting-table">
                ...
                $stmt = $db->prepare("SELECT * FROM waiting_lobby WHERE game = 'League of Legends' ORDER BY created_at DESC");
                $stmt->execute();
